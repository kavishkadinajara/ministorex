...
import { deleteStore, getStoreById } from "@/lib/api/stores";
...
export default function StoreDetailPage() {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-3">
      ...
      {/* Sidebar - Right Side */}
      <div className="space-y-6 lg:mt-[88px]"> {/* Offset to align with card top if header is roughly 88px, or just let it stack */}
         {/* Contact Info Card */}
        <Card>
          <CardHeader>
